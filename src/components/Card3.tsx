  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 z-20 text-white text-center">
        <h2 className="h2 font-bold text-primary">{title} <span className="text-white">Studio</span></h2>
        ...
        {/* Button See Details */}
        <button className="bg-primary text-white sb2 py-2 px-4 rounded-lg mt-4">See Details</button>
      </div>
    </div>
  );
};
