...
const TypeOfStudio: React.FC<TypeOfStudioProps> = ({
  type,
  facilities,
  capacity,
  price,
    ...
    <div className="bg-white p-6 rounded-lg shadow-md style2">
      ...
      <div className="relative">
        ...
        <div className="absolute bottom-10 right-4 text-right">
          ...
          <p className="sb1 text-accent2 mb-4">Rp{price}</p>
        </div>

        {/* Button Section */}
        <Link href="/bookingdetails">
          <button
            className={`absolute bottom-0 right-4 space-y-4 text-right bg-primary text-white px-4 py-2 rounded-md transition-transform transform hover:scale-110 ${
