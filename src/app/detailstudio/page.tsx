...
const DetailStudioPage = () => {
  ...
  return (
    <div className="bg-1A1A1A min-h-screen mb-24 text-black">
      ...
      <div className="container mx-auto p-4 bg-white rounded-lg shadow-md">
        <div className="flex justify-between">
          <h2 className="text-black h2">
            {" "}
            <span className="text-primary">SoulChord</span> Studio
          </h2>
        ...
        <div className="flex-col mt-4 text-black">
          <div className="mt-4  boxStyle p-4">
            <p style={{ textAlign: "justify" }}>
              SoulChard Studio is a space designed to cater to the needs of
              musicians, producers, and music lovers, whether for professional
              recording, band practice, or music workshops. The studio is
              equipped with modern equipment, such as digital mixers,
              high-quality microphones, and premium musical instruments. The
              room acoustics are professionally tuned to produce clear and
              immersive sound quality. Additionally, the studio offers a
              comfortable space with an aesthetic and creative design to inspire
              its users.
            </p>
          </div>
          <div className="flex justify-between mt-4 gap-4">
            <div className="boxStyle p-4 w-full sm:w-1/2">
              ...
              <div className="flex items-center mb-2">
                ...
                />
                <p className="b1">
                  Jl. Ir. H. Juanda No. 157, Dago Atas, Bandung, Jawa Barat
                </p>
              </div>
              <p className="sb1">Strategic Area</p>
              <ul className="list-disc ml-6">
                <li>
                  Close to cafes and restaurants for relaxing after recording
                  sessions.
                </li>
                <li>
                  A spacious parking area is provided for private vehicles.
                </li>
                <li>
                  Access to public transportation, including local minibusses
                  and online ride services, is available.
                </li>
              </ul>
            </div>
            ...
            <div className="boxStyle p-4 w-full sm:w-1/2">
              ...
              <div className="grid grid-cols-2 gap-4">
                {/* isi iconDesc */}
                <IconDesc
                  icon="/Monitor-Recorder.png"
                  description="Recording Booth"
                />
                <IconDesc
                  icon="/Call-Center-Support-Service.png"
                  description="24-hours services"
                />
                ...
                <IconDesc
                  icon="/Hotel-Air-Conditioner.png"
          ...
          <div className="flex flex-col gap-4 mt-4 ">
            <TypeOfStudio
              ...
              facilities={[
                ...
                "Ergonomic chair for work comfort",
              ]}
              capacity="1-2 people"
              price="199.000"
            ...
            <TypeOfStudio
              ...
              facilities={[
                "Drum kit and amplifiers",
                "Microphones for vocals and instruments",
                "Multi-channel mixer for multi-track recording",
                "Acoustic space with professional soundproofing",
              ]}
              capacity="3-5 people"
              price="349.000"
        ...
        <div>
          <h3 className="h3 mt-4">
            Review from <span className="text-primary">SoulChord</span> Studio
            Users
          </h3>
          <div className="flex flex-col gap-4 mt-4">
            <Review
