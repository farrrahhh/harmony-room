const Footer = () => {
    return (
        <footer className="bg-dark3 text-white p-8 flex flex-col md:flex-row gap-8 border-t border-grey mt-8">
            {/* About Section */}
            <div className="flex-1">
                <p className="sb1 mb-2">About Us</p>
                <p className="b1">
                    Experience the Ultimate Music Studio by checking out some of the best studios that we got for your band!
                </p>
            </div>
